...
public class InstanceMethWithObjectRefDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Days when maximum temperature equals 89: " + count);
        ...
        System.out.println("Days when temperature was equals 12: " + count);

        count = counter(weekDayHighs, HighTemp::lessThatTemp, new HighTemp(89));
        System.out.println("Days when maximal temperature was less than 89");

        count = counter(weekDayHighs2, HighTemp::lessThatTemp, new HighTemp(19));
        System.out.println("Days when maximal temperature was less than 19");
    }
}
